...
<body>
    ...
    <section class="py-5">
        <div class="main-1">
            <?php
            $r = $abc->tampil_album($_GET['id_album']);
            echo $r->id_album;
            ?>
            <form name="form" class="container" method="POST" action="proses-album.php">
                <input type="hidden" name="aksi" value="ubah" />
                <input type="hidden" name="id_album" value="<?= $r->id_album ?>" />
                <div class="mb-3">
                    <label class="form-label">ID Album</label>
                    <input type="text" class="form-control" name="id_album" id="formGroupExampleInput" value="<?= $r->id_album ?>" disabled>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="nama_album" id="formGroupExampleInput2" value="<?= $r->nama_album ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Tanggal Rilis</label>
                    <input type="text" class="form-control" name="tanggal_rilis" id="formGroupExampleInput2" value="<?= $r->tanggal_rilis ?>">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Deskripsi</label>
                    <input type="text" class="form-control" name="deskripsi" id="formGroupExampleInput2" value="<?= $r->deskripsi ?>">
                </div>
                <div class="col-auto">
                    <button type="submit" name="ubah" class="btn btn-primary">Edit Album</button>
                </div>
            </form>
        </div>
